...
I need you to perform a comprehensive security audit and fix every vulnerability in this project. This is a Next.js e-commerce application using Supabase (database + auth), a third-party payment gateway, and Resend/SMS for notifications. You have access to the Supabase MCP — use it to inspect and fix the database directly.
