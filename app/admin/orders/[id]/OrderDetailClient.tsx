      ...
      <div className="print-section hidden print:block bg-white p-8">
        <div className="border-2 border-gray-800 p-6">
          ...
          <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4 mb-4">
            <div>
              <h1 className="text-2xl font-bold">{process.env.NEXT_PUBLIC_SITE_NAME || 'Undaunted Treasure Trove'}</h1>
          ...
          <div className="border-t-2 border-gray-800 pt-4 text-center text-sm text-gray-600">
            ...
            <p>Questions? See your order confirmation email or our Contact page.</p>
          </div>
        </div>
      </div>
